...
**Affiliation.** Yokohama University of Pharmacy, 601 Matano-cho, Totsuka-ku, Yokohama 245-0066, Japan.
...
**Keywords.** long noncoding RNA; bulk RNA-seq; cell-composition deconvolution; random-effects meta-analysis; partial correlation; mediation analysis; *IL5*; type-2 inflammation; functional genomics.

**Transfer notice.** Transferred from *Briefings in Bioinformatics* (BIB-26-1123) via OUP Transfer Desk on 2026-05-19. No peer review at the previous venue (editorial-screen decline).
