...
**Article type:** Original Article (methodology)
**Date:** 2026-05-19
...
I am writing to submit the above manuscript for consideration in *Briefings in Functional Genomics* via the OUP Transfer Desk. The work addresses a recurring and, in our view, under-recognised interpretive failure of bulk-tissue RNA-seq analysis as it is currently applied to long noncoding RNA (lncRNA) candidates in clinical functional genomics.
...
**Why *Briefings in Functional Genomics* is the natural home for this paper.**

- **Functional genomics methodology fit.** The contribution is a functional genomic analysis framework, not a single biological finding. The pipeline integrates components familiar to functional genomics readers (DESeq2, limma, metafor, ppcor, mediation, signature scoring, deconvolution) into a discipline for re-reading bulk-tissue null results on cell-type-restricted candidates, and explicitly defines the parameter choices and limitations of each step. *Briefings in Functional Genomics* explicitly serves the international forum for "the use, development and exploitation of functional genomic approaches in all areas of biological research," which exactly describes the present contribution.
...
**Transfer notice.** This manuscript was transferred from *Briefings in Bioinformatics* (BIB-26-1123) via the OUP Transfer Desk on 2026-05-19. The previous handling at *Briefings in Bioinformatics* did not result in a peer review (editorial-screen decline); no scientific critique was provided. The submission package is unchanged in scientific content. I have selected the subscription publication route.
