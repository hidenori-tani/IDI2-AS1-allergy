# ============================================================
# Fig 3 — Sample-level IDI2-AS1 vs IL5 correlation per dataset
# v2: BBRC font-size revision (editor letter BBRC-26-2497, M. Lichten)
#
# Changes vs v1:
#   - ggsave width 11 → 9 in (so post-scale to 480pt source fonts survive ≥8pt)
#   - theme_bw(base_size = 11) → 12, strip 9 → 11, axis tick text increased
# ============================================================
...
cat("\nSaved Fig3_correlation_scatter.pdf (v2: 9x7 in, base_size=12)\n")
